...
#   bash 90-run-extensions-scripts.sh --workspace-folder <path>
#
# Arguments:
...
DEVCONTAINER_DIR="$WORKSPACE_FOLDER/.devcontainer"

# shellcheck disable=SC1091
source "$DEVCONTAINER_DIR/run-scripts.sh"

if [ -d "$WORKSPACE_FOLDER/.devcontainer-extensions/post-create.d/" ]; then
    run_scripts_in_folder "$WORKSPACE_FOLDER" "$WORKSPACE_FOLDER/.devcontainer-extensions/post-create.d/" " .. [ user extensions ] "
fi
